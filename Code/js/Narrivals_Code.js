...
function initialize()
    {
      ...
      var price_us=["57.00","21.00","120.00","111.00","30.00","65.00"]; 
      var price_uk=["43.90","16.20","92.40","85.50","23.10","50.10"];
      var price_pk=["9,490","3,500","19,980","18,480","5,000","10,820"];   
      ...
      {    
        ...
        for (var h=1; h<37; h++)
       {
        ...
        for (var i=1; i<7; i++) { var cur_id="currency"+i; 
