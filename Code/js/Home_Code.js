...
function initialize()
    {
      ...
      {    
        ...
        document.getElementById('curr_id1').innerHTML="$";
        document.getElementById('curr_id2').innerHTML="$";
        document.getElementById('curr_id3').innerHTML="$";
        document.getElementById('curr_id4').innerHTML="$";
        document.getElementById('curr_id5').innerHTML="$";
        document.getElementById('curr_id6').innerHTML="$";

        document.getElementById('price_id1').innerHTML="70.00";
        document.getElementById('price_id2').innerHTML="30.00";
        document.getElementById('price_id3').innerHTML="35.00";
        document.getElementById('price_id4').innerHTML="45.00";
        document.getElementById('price_id5').innerHTML="30.00";
        document.getElementById('price_id6').innerHTML="120.00";
      ...
      { 
        ...
        document.getElementById('price_id1').innerHTML="53.90";
        document.getElementById('price_id2').innerHTML="23.10";
        document.getElementById('price_id3').innerHTML="27.00";
        document.getElementById('price_id4').innerHTML="34.70";
        document.getElementById('price_id5').innerHTML="23.10";
        document.getElementById('price_id6').innerHTML="92.40";
      ...
      { 
        document.getElementById('curr_id1').innerHTML="PKR";
        document.getElementById('curr_id2').innerHTML="PKR";
        document.getElementById('curr_id3').innerHTML="PKR";
        document.getElementById('curr_id4').innerHTML="PKR";
        document.getElementById('curr_id5').innerHTML="PKR";
        document.getElementById('curr_id6').innerHTML="PKR";

        document.getElementById('price_id1').innerHTML="11,660";
        document.getElementById('price_id2').innerHTML="5,000";
        document.getElementById('price_id3').innerHTML="5,830";
        document.getElementById('price_id4').innerHTML="7,490";
        document.getElementById('price_id5').innerHTML="5,000";
        document.getElementById('price_id6').innerHTML="19,980";
      ...
      $(document).ready(function(){
        ...
        if (sessionStorage.getItem("user")==null)
        {
          $(document).ready(function(){
            ...
            document.getElementById('cart').style.hover="none";
        ...
        else
        {
         ...
         else 
         {
          ...
          $(document).ready(function(){
            ...
            if (c1.matches)
            {
             /* document.getElementById('cart').style.borderTop="none";
...
document.getElementById('count').innerHTML=i_count;
    ...
    function checkout_fun()
                 ...
                 { 
                  ...
                  if($(".top-alert").is(":hidden"))
                  {
                  var d1=window.matchMedia("(min-width: 800px)");
                  var d2=window.matchMedia("(min-width: 550px) and (max-width: 800px)");
                  ...
                  if (d1.matches)
                  {
                  document.getElementById('top-p1').style.marginTop="10vw";
                  document.getElementById('top-p2').style.marginTop="23vw";
                  document.getElementById('top-p3').style.marginTop="31vw";
                  document.getElementById('top-b1').style.marginTop="39vw";
                  }
        
                  else if (d2.matches)
                  {
                    document.getElementById('top-p1').style.marginTop="17vw";
                  document.getElementById('top-p2').style.marginTop="42vw";
                  document.getElementById('top-p3').style.marginTop="60vw";
                  document.getElementById('top-b1').style.marginTop="77vw";
                  }
        
                  else if (d3.matches)
                  {
                    document.getElementById('top-p1').style.marginTop="27vw";
                  document.getElementById('top-p2').style.marginTop="64vw";
                  document.getElementById('top-p3').style.marginTop="84vw";
                  document.getElementById('top-b1').style.marginTop="107vw";
                  }
                  }
                }); 
                }